...
public interface FulfillmentStateService {List<FulfillmentClaim> claimDue(int limit,Duration leaseDuration);void recordResult(FulfillmentClaim claim,GatewayResult result,long durationMs);}
