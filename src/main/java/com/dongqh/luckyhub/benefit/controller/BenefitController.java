...
public class BenefitController { private final BenefitQueryService service; private final PhysicalClaimService claims; @Autowired public BenefitController(BenefitQueryService service, PhysicalClaimService claims){this.service=service;this.claims=claims;} public BenefitController(BenefitQueryService service){this.service=service;this.claims=null;}
